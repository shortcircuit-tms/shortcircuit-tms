...
def pid_set_velocity(target_velocity):
    left_motor_velocity=left_drive_smart.velocity(PERCENT)
    right_motor_velocity=right_drive_smart.velocity(PERCENT)
    new_left_motor_velocity=left_motor_velocity+0.5*(target_velocity-left_motor_velocity)
    new_right_motor_velocity=right_motor_velocity+0.5*(target_velocity-right_motor_velocity)
